...
export default function SignupForm() {
   return (
      <Card className="min-w-80 md:min-w-[620px] lg:min-w-[740px] transition-width duration-300 border-none shadow-none">
         <CardHeader>
         ...
         <CardContent>
            <form className="space-y-5">
               <div className="grid md:grid-cols-1 w-full items-center gap-4 space-y-1">
